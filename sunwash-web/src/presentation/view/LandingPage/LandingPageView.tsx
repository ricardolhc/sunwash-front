...
import { Sun, Calendar, ArrowRight, Star } from "lucide-react";
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 text-slate-800 antialiased">
      ...
      <main className="flex-1">
        ...
        <section
          id="como-funciona"
          className="py-16 lg:py-24 bg-white border-b border-slate-100"
        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
              ...
              <div className="relative bg-slate-50/70 rounded-2xl p-8 border border-slate-100 hover:shadow-md transition-shadow">
                ...
                <p className="text-slate-600 text-sm leading-relaxed">
                  Informe a quantidade de placas, selecione a melhor data e
                  envie uma foto do seu telhado em menos de 2 minutos.
                </p>
              </div>
              ...
              <div className="relative bg-slate-50/70 rounded-2xl p-8 border border-slate-100 hover:shadow-md transition-shadow">
                ...
                <p className="text-slate-600 text-sm leading-relaxed">
                  ...
                  anti-risco e água desmineralizada pura sem produtos
                  corrosivos.
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-xs flex flex-col justify-between">
                <div className="space-y-3">
                  ...
                  <p className="text-sm text-slate-600 italic">
                    "Excelente atendimento. Fizeram a autorização da caução no
                    cartão e só cobraram depois que o serviço terminou e conferi
                    as fotos."
                  </p>
                </div>
                <div className="pt-4 border-t border-slate-100 mt-4 flex items-center gap-3">
              ...
              <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-xs flex flex-col justify-between">
                <div className="space-y-3">
                  ...
                  <p className="text-sm text-slate-600 italic">
                    "Serviço profissional e com segurança total. Usam água pura
                    e equipamentos apropriados. Recomendo para todos com placas
                    solares."
                  </p>
                </div>
                <div className="pt-4 border-t border-slate-100 mt-4 flex items-center gap-3">
